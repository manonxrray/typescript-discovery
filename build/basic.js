 ...
 */
//  x = 42; // ERROR : x is type string but now we try to reassign another type (number)
/**
...
let zz;
zz = 41;
//  zz = "abc"; // so now that we declared a specific type BEFORE, zz is type number and not any
//== SIMPLE ARRAYS ==//
/**
...
//  bb = [1, 2, 3]; // impossible because it has to be the shown template ! not number x3
/**
